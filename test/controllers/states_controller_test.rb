...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference("State.count") do
      post states_url, params: { state: { available: @state.available, leased: @state.leased, rent: @state.rent, sale: @state.sale, sold: @state.sold } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { available: @state.available, leased: @state.leased, rent: @state.rent, sale: @state.sale, sold: @state.sold } }
