...
class StatesTest < ApplicationSystemTestCase
  ...
  test "should create state" do
    ...
    fill_in "Available", with: @state.available
    fill_in "Leased", with: @state.leased
    fill_in "Rent", with: @state.rent
    fill_in "Sale", with: @state.sale
    fill_in "Sold", with: @state.sold
