...
class DepartmentsTest < ApplicationSystemTestCase
  ...
  test "should create department" do
    ...
    fill_in "Bathroom", with: @department.bathroom
    fill_in "Bedroom", with: @department.bedroom
    fill_in "Building", with: @department.building_id
    fill_in "Client", with: @department.client_id
    fill_in "Image", with: @department.image
    fill_in "Number", with: @department.number
    fill_in "Price", with: @department.price
    fill_in "State", with: @department.state_id
